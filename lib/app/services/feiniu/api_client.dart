...
class ApiException implements Exception {
  ...
  /// 面向用户的友好提示：服务端 message 非空时优先，否则按真实 FNOS 业务码映射。
  ///
  /// 错误码枚举取自 FNOS 官方前端：100002=InvalidArgs、100005=NotFound、
  /// 120001=Unauthorized。服务端 `msg` 通常为英文（如 "invalid arguments"），
  /// 这里给出中文兜底文案。
