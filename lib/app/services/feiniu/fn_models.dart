...
///
/// 实际接口响应示例：
/// {"ddns":null,"ipv4":["192.168.11.xxx",...],"ipv6":[],
///  "publicIpv4":["120.239.xx.xxx"],"publicIpv6":["2409:..."],
...
class FnConnectionParams {
  ...
  factory FnConnectionParams.fromJson(Map<String, dynamic> json) {
    final Map<String, dynamic> port = json['port'] as Map<String, dynamic>? ??
...
///   HTTPS 兜底。IP 直连多为自签名证书，HTTP 可避开原生栈证书校验。
/// - **中继 / 域名**（relay）：**仅 HTTPS**。
///
